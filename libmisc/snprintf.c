...
#if defined(NEED_ASPRINTF)
EXPORT int asprintf(char **ptr, const char *fmt, /*args*/ ...) {
  va_list ap;
  size_t str_m;
  int str_l;
...
#if defined(NEED_VASPRINTF)
EXPORT int vasprintf(char **ptr, const char *fmt, va_list ap) {
  size_t str_m;
  int str_l;
...
#if defined(NEED_ASNPRINTF)
EXPORT int asnprintf (char **ptr, size_t str_m, const char *fmt, /*args*/ ...) {
  va_list ap;
  int str_l;
...
#if defined(NEED_VASNPRINTF)
EXPORT int vasnprintf (char **ptr, size_t str_m, const char *fmt, va_list ap) {
  int str_l;
